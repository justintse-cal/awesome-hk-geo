...
> A curated list of awesome Hong Kong webmap resources to foster ideas and drive geospatial web development in Hong Kong.
...
* [CEDD Major Project](https://www.cedd.gov.hk/eng/our-projects/major-projects/index.html) - Information on major projects on the Civil Engineering and Development Department's website presented in a map view
...
* [Zone In](https://khwong12.github.io/OZP_buffer_stat/) - This web map allows users to explore Hong Kong land use zonings
* [Well Being Map](https://wellbeingmap.org/?ref=geospatial.hk) - This web map helps users to find the most livable areas tailored to their needs
...
* [Hong Kong Traffic Injury Collision Database](https://streetreset-hktrafficcollisions.share.connect.posit.cloud/) - A project aims to visualize Hong Kong traffic collision data with interactive mapping
...
* [Geographical Information System on Hong Kong Heritage](https://gish.amo.gov.hk/internet/index.html?dm-all=1) -
...
* [Hong Kong Pop Culture Map](https://digital.lib.hkbu.edu.hk/culture-map/index.php) - This web map presents film locations, music venues and cultural hotspots
