# Awesome Hong Kong Geo [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
> A curated list of awesome Hong Kong geospatial resources to foster ideas and drive geospatial digital development in Hong Kong.

## Table of Contents
- [Web App](#web-app)
  - [Environment](#environment)
  - [Cities & Urban Planning](#cities--urban-planning)
...
* [City Dashboard](https://data.gov.hk/en/city-dashboard) - A series of city dashboards
* [Real-time Data Dashboard](https://www.arcgis.com/apps/dashboards/e8ae3f3ab03e44ada342d95c957d406b) - Real-time traffic and environmental data in Hong Kong
* [District-Based Spatial Information Dashboard](https://usecases.csdi.geodata.gov.hk/dbsid_en.html?lang=en&fontSize=1) - Simple interactive data visualization tools regarding district-based analytics
...
* [Ways of Remembering Hong Kong](https://waysofrememberinghongkong.hkaa.co/) - A collaborative map where anyone can anonymously share personal memories connected to Hong Kong
* [My Neon City](https://www.neonsigns.hk/?lang=en) - Locations of neon sign in Hong Kong
* [Hong Kong Historic Maps](https://www.hkmaps.hk/) - A collection of georeferenced Hong Kong historic maps
...
* [mappinghk.org](https://www.mappinghk.org/map) - A community-based mapping of Hong Kong's culture and history
...
* [Hong Kong Traffic Injury Collision Database](https://streetreset-hktrafficcollisions.share.connect.posit.cloud/) - Understanding Hong Kong traffic collision data with interactive mapping
...
* [Vector Map Label](https://portal.csdi.gov.hk/csdi-webpage/apidoc/VectorMapLabelAPI) - Retrieve vector map tiles with place name labels
* [Map Label](https://portal.csdi.gov.hk/csdi-webpage/apidoc/MapLabelAPI) - Retrieve map tiles with place name labels
* [Imagery Map](https://portal.csdi.gov.hk/csdi-webpage/apidoc/ImageryMapAPI) - Retrieve imagery map tiles
